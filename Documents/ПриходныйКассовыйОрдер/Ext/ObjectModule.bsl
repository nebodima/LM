...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("СправочникСсылка.LM_Абонемент") Тогда
		
		ВидОперации			= Перечисления.LM_ВидыОпераций.КассаУченики;
		LM_ФизЛицо			= ДанныеЗаполнения.Ссылка.ФизЛицо;
		Абонемент			= ДанныеЗаполнения.Ссылка;
		ДокументОснования 	= ДанныеЗаполнения.Ссылка;
		ПредметОбучения 	= ДанныеЗаполнения.Ссылка.ПредметОбучения;
		СуммаДокумента	    = ДанныеЗаполнения.Ссылка.ЦенаАбонемента;
