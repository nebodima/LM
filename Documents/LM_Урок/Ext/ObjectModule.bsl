Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Не ПометкаУдаления Тогда
		...
		Для Каждого Стр из Ученики Цикл				
			...
			Если LMНастроки.Свойство("ТребоватьОписаниеКНеоплаченнымУрокам") Тогда 
				//Если ЗначениеЗаполнено(Организация) Тогда			
				Если НачалоДня(Дата) >= LMНастроки.ТребоватьОписаниеКНеоплаченнымУрокам Тогда
					Если НЕ Стр.СписатьОплату и НЕ ЗначениеЗаполнено(Стр.Заметка) Тогда
						Отказ = Истина;
						Сообщить("В строке " +Стр.НомерСтроки+ " не указан комментарий к списанию оплаты!"+Символы.ПС+ "ТребоватьОписаниеКНеоплаченнымУрокам с " +LMНастроки.ТребоватьОписаниеКНеоплаченнымУрокам);
					КонецЕсли;
				КонецЕсли; 						
			КонецЕсли;			
