...
Функция ПроверитьАбонемент(Стр)
	...
	ИначеЕсли Стр.Абонемент.Активный Тогда
		...
		Если Стр.Абонемент.ДатаНачала < Ссылка.Дата Тогда
			Возврат "У ученика " +Стр.Ученик+ " дата начала абонемента меньше даты урока! " +Стр.Абонемент+ " строка: " +Стр.НомерСтроки;
		ИначеЕсли Стр.Абонемент.ДатаОкончания > Ссылка.Дата Тогда
			Возврат "У ученика " +Стр.Ученик+ " дата окончания абонемента больше даты урока! " +Стр.Абонемент+ " строка: " +Стр.НомерСтроки;			
		КонецЕсли;
