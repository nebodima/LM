...
Функция ПроверитьАбонемент(Стр)
	...
	ИначеЕсли Стр.Абонемент.Активный Тогда
		...
		Если Стр.Абонемент.Приостановка Тогда
			Если Ссылка.Дата >= Стр.Абонемент.ДатаПриостановки и  Ссылка.Дата <= Стр.Абонемент.ДатаВозобновления Тогда
				Возврат "" +Ссылка+ " - На " +Ссылка.Дата+ " у ученика " +Стр.Ученик+ " приостановлен абонемент! " +Стр.Абонемент+ " строка: " +Стр.НомерСтроки;
			КонецЕсли;
		КонецЕсли;
