...
Процедура ВыполнитьНаСервере()
	...
	Если Элементы.Страницы.ТекущаяСтраница.Заголовок = "Создание занятий" Тогда	
...
Процедура НайтиДокументыНаСервере()
	...
	Для Каждого Стр из Элементы.Календарь.ВыделенныеДаты Цикл
		...
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл 					
			...
			НовДок.Помещение 			= ВыборкаДетальныеЗаписи.Ссылка.Помещение;
			НовДок.Педагог 				= ВыборкаДетальныеЗаписи.Ссылка.Педагог;
		КонецЦикла;				
