...
Процедура ОбновитьВидимость()
	...
	Элементы.Группа7.Заголовок = "Список приостановок (" +Объект.Приостановки.Количество()+ ")";
...
Процедура ЗаполнитьТЗОплат()
	...
	Попытка
		...
		Если ВремТЗ.Количество()<> 0 Тогда		    
			...
			Если ЗначениеЗаполнено(Объект.КоличествоЗанятий) Тогда
				ОстатокУроковЧасов = "" +(Объект.КоличествоЗанятий - ИтогоУроков)+ " ур.";
			ИначеЕсли ЗначениеЗаполнено(Объект.КоличествоЧасов) Тогда 
				ОстатокУроковЧасов = "" +(Объект.КоличествоЧасов - ИтогоЧасов)+ " ч.";
			КонецЕсли;
