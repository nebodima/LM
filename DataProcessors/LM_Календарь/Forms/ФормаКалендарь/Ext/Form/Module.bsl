...
Функция ДействиеСДокументом()
	...
	Если ТекДанные.Количество() = 1 Тогда
		...
		Если ТекДанные[0].ЗначенияИзмерений.Количество() = 1 Тогда
			...
			Если НачалоЧаса(ТекДанные[0].Значение.Дата) <> ТекДанные[0].Начало
				и КонецЧаса(ТекДанные[0].Значение.Окончание) <> ТекДанные[0].Конец Тогда
				//Это смена помещения и перенос
				С.Вставить("Действие","Сменить помещение и переместить по времени " +ТекДанные[0].Значение+ " ?");
			...
			//Это смена Помещения
			С.Вставить("Действие","Сменить помещение у " +ТекДанные[0].Значение+ " ?");
			С.Вставить("Помещение",ТекДанные[0].ЗначенияИзмерений.Получить("Помещение"));
		...
		Иначе
			...
			Если НачалоЧаса(ТекДанные[0].Значение.Дата) <> ТекДанные[0].Начало
				...
				//Это перенос
				С.Вставить("Действие","Переместить по времени " +ТекДанные[0].Значение+ " ?");
