...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	Метаданные.Документы.LM_Урок.ПолноеИмя(),
	"Дата", "УчетУроков", "АвторДокумента");
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,
	Метаданные.Документы.LM_СписаниеОстатков.ПолноеИмя(),
	"Дата", "УчетУроков", "АвторДокумента");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	
	Метаданные.Документы.LM_ПеремещениеДенег.ПолноеИмя(),
	"Дата", "УчетУроков", "АвторДокумента");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	
	Метаданные.Документы.LM_НачислениеБонусов.ПолноеИмя(),
	"Дата", "УчетУроков", "АвторДокумента");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	
	Метаданные.Документы.LM_РасчетЗарплаты.ПолноеИмя(),
	"Дата", "УчетУроков", "АвторДокумента");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	
	Метаданные.Документы.LM_ГрафикРабочегоВремениПедагога.ПолноеИмя(),
	"Дата", "УчетУроков", "АвторДокумента");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных,	
	Метаданные.Документы.LM_ДополнительныеРасходы.ПолноеИмя(),
	"Дата", "УчетУроков", "АвторДокумента");
