...
Функция МассивРеквизитовОбъектаДляФормированияПредставления(ИмяДокумента) Экспорт
	...
	Если ИмяДокумента = "ПриходныйКассовыйОрдер" Тогда  		
		МассивДопРеквизитов.Добавить("ДокументОснования");		
	ИначеЕсли ИмяДокумента = "LM_Урок" Тогда
		МассивДопРеквизитов.Добавить("ДокументОснования");
	ИначеЕсли ИмяДокумента = "РасходныйКассовыйОрдер" Тогда
		МассивДопРеквизитов.Добавить("ДокументОснования");
	ИначеЕсли ИмяДокумента = "LM_ПеремещениеДенег" Тогда
		МассивДопРеквизитов.Добавить("ДокументОснования");
	ИначеЕсли ИмяДокумента = "LM_СписаниеОстатков" Тогда
		МассивДопРеквизитов.Добавить("ДокументОснования");
	ИначеЕсли ИмяДокумента = "LM_РасчетЗарплаты" Тогда
		МассивДопРеквизитов.Добавить("ДокументОснования");
	ИначеЕсли ИмяДокумента = "LM_ДополнительныеРасходы" Тогда
		МассивДопРеквизитов.Добавить("ДокументОснования");
	КонецЕсли; 
